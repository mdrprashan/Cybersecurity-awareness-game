...
Security fixes applied:
  ...
  - debug=True only in development, False in production
  - HTTP security headers added via after_request hook
  - Session cookie hardening (HttpOnly, SameSite, timeout)
"""
...
def create_app():
    ...
    # SECURITY FIX 1: Secret key from environment — never hardcoded
    ...
    if not secret_key:
        ...
        # Dev fallback — clearly labelled, not suitable for production
    ...
    # SECURITY FIX 2: Session cookie hardening
    app.config['SESSION_COOKIE_HTTPONLY']  = True   # JS cannot read the cookie
    app.config['SESSION_COOKIE_SAMESITE']  = 'Lax'  # CSRF mitigation
    app.config['SESSION_COOKIE_SECURE']    = os.environ.get('FLASK_ENV') == 'production'
    app.config['PERMANENT_SESSION_LIFETIME'] = timedelta(hours=2)  # auto-expiry
    ...
    # SECURITY FIX 3: HTTP security headers on every response
    @app.after_request
...
def _seed_challenges():
    ...
    challenges = [
        ...
        Challenge(category='phishing', difficulty='medium',
                  ...
                  correct_answer='B',
                  explanation='Typosquatting replaces letters with similar-looking characters. Always check sender domains carefully.'),
        ...
        Challenge(category='phishing', difficulty='medium',
                  ...
                  correct_answer='B',
                  explanation='Generic greetings combined with urgency are hallmarks of phishing.'),
        ...
        Challenge(category='phishing', difficulty='hard',
                  ...
                  correct_answer='C',
                  explanation='Spear phishing targets specific individuals using personal details to appear more convincing.'),

        Challenge(category='phishing', difficulty='hard',
                  question="A colleague's email sends you a link to an http:// document. What should you do?",
                  ...
                  correct_answer='B',
                  explanation='Compromised email accounts are used in spear phishing. Always verify through a separate channel.'),
        ...
        Challenge(category='password', difficulty='easy',
                  ...
                  option_d='123456789',
                  correct_answer='C',
                  explanation='Strong passwords use uppercase, lowercase, numbers, and symbols with no dictionary words.'),
        ...
        Challenge(category='password', difficulty='easy',
                  ...
                  correct_answer='B',
                  explanation='Password managers generate and store unique strong passwords so you only remember one master password.'),
        ...
        Challenge(category='password', difficulty='medium',
                  ...
                  correct_answer='B',
                  explanation='If you reuse passwords, a breach on one site gives attackers access to all your other accounts.'),
        ...
        Challenge(category='password', difficulty='medium',
                  ...
                  correct_answer='B',
                  explanation='MFA adds a second factor making it much harder for attackers even if they have your password.'),
        ...
        Challenge(category='password', difficulty='hard',
                  ...
                  correct_answer='B',
                  explanation='Brute-force attacks try all possible combinations. Long, complex passwords make this computationally infeasible.'),
        ...
        Challenge(category='browsing', difficulty='easy',
                  ...
                  correct_answer='B',
                  explanation='The padlock means HTTPS is active. It does NOT guarantee the website itself is safe or legitimate.'),

        Challenge(category='browsing', difficulty='easy',
                  question='A pop-up says "Your computer is infected! Call this number immediately." What should you do?',
                  ...
                  correct_answer='B',
                  explanation='This is a classic tech support scam. Legitimate security software never shows pop-ups asking you to call a number.'),

        Challenge(category='browsing', difficulty='medium',
                  question='What is a VPN and when is it most useful?',
                  option_a='A virus protection network',
                  option_b='A Virtual Private Network that encrypts your traffic — especially on public Wi-Fi',
                  option_c='A way to speed up your internet connection',
                  option_d='A tool to download files faster',
                  correct_answer='B',
                  explanation='VPNs encrypt your internet traffic, protecting you on unsecured public Wi-Fi networks.'),
        ...
        Challenge(category='browsing', difficulty='medium',
                  ...
                  correct_answer='B',
                  explanation='Public Wi-Fi is unsecured. A VPN encrypts your traffic and you should avoid banking or sensitive logins.'),
        ...
        Challenge(category='browsing', difficulty='hard',
                  ...
                  option_b='Malware that automatically downloads when you visit a compromised website',
                  option_c='Downloading software while driving',
                  option_d='A legitimate way to update your browser',
                  correct_answer='B',
                  explanation='Drive-by downloads exploit browser or plugin vulnerabilities. Keep your browser updated as the best defence.'),
    ]
...
def _seed_badges():
    ...
    badges = [
        Badge(name='Security Rookie',     description='Answered your first challenge correctly',  icon='⭐', requirement=1),
        Badge(name='Phishing Detector',   description='Correctly answered 3 phishing challenges', icon='🎣', requirement=3),
        Badge(name='Password Pro',        description='Correctly answered 3 password challenges', icon='🔐', requirement=3),
        Badge(name='Safe Surfer',         description='Correctly answered 3 browsing challenges', icon='🌐', requirement=3),
        Badge(name='CyberQuest Champion', description='Completed all 15 challenges',              icon='🏆', requirement=15),
    ]
...
if __name__ == '__main__':
    app = create_app()
    # SECURITY FIX 4: debug=False in production
